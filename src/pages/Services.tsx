...
import { Home, Calendar, Clock, MapPin, User, Phone } from 'lucide-react';
...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      price: 'Rp 200.000',
      duration: '30 menit',
      image: 'https://images.pexels.com/photos/6235151/pexels-photo-6235151.jpeg?auto=compress&cs=tinysrgb&w=400',
      includes: [
